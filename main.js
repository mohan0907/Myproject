      ...
      todoItems.forEach((item) => {
        ...
        itemList.insertAdjacentHTML(
          ...
          `<li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <span>
                <a href="#" data-done><button type="button" class="btn btn__done">Done <span class="visually-hidden">java</span></button></a>
                <a href="#" data-edit><button type="button" class="btn btn_edit">Edit <span class="visually-hidden">java</span></button></a>
                <a href="#" data-delete><button type="button" class="btn btn__danger">Delete <span class="visually-hidden"></span></button></a>
            </span>
          </li>`
        );
        handleItem(item);
